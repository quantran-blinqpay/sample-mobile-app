...
## Get recommend item (Paginated)
- **Endpoint**: `GET /api/recombee/recommend-items`
- **Header**:
  - `Accept` = "application/vnd.dw.v1.4+json", 
  - `User-Agent` = "kWXVDsQ7zJ98EYEGoLZmWThdWSwyt6GG", 
- **Query Params**:
  - `scenario` (String) - Currently, use the default value "you_may_like_homepage".
  - `locale` (String) - Currently, use the default locale "NZ".
- **Response Example**:
```json
{

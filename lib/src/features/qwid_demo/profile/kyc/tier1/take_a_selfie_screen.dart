...
@RoutePage(name: takeASelfieRoute)
...
class _TakeASelfieScreenState extends State<TakeASelfieScreen> {
  ...
  Widget _buildActionButton() {
    return SafeArea(
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        // Capture button
        Expanded(child: _buildButton('Retake Photos', const Color(0xffffffff).withOpacity(0.15), () {
  ...
  void _usePhoto(BuildContext context) async {
    ...
    if (selected != null) {
      ...
      // Get.until((route) => Get.currentRoute == AppRoutes.kycRoute);
    }
  }
}

...
@RoutePage(name: identityVerificationRoute)
            ...
            child: ListView(
              children: [
                ...
                _optionTile(
                  ...
                  onTap: () {
                    context.router.push(const NationIdentificationScreenRoute());
                  },
                ),
                ...
                _optionTile(
                  ...
                  onTap: () {
                    context.router.push(const BankVerificationNumberScreenRoute());
                  },
                ),
              ],
            ),

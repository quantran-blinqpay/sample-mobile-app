...
import 'package:qwid/src/features/qwid_demo/profile/kyc/component/spacer_digits_input_format.dart';
import 'package:qwid/src/router/route_names.dart';
import 'package:qwid/src/router/router.dart';

@RoutePage(name: bankVerificationNumberRoute)
class BankVerificationNumberScreen extends StatefulWidget {
  const BankVerificationNumberScreen({super.key});

  @override
  State<BankVerificationNumberScreen> createState() => _BankVerificationNumberScreenState();
}

class _BankVerificationNumberScreenState extends State<BankVerificationNumberScreen> {
            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  inputFormatters: [
                    FilteringTextInputFormatter.digitsOnly, // prevents non-digits
                    SpacedDigitsInputFormatter(maxDigits: 11), // set to your needed length
                  ],
                  maxLength: 21,
                  cursorColor: blue,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: _isValid
                        ...
                        Future.delayed(const Duration(seconds: 2), () {
                          ...
                          context.router.push(const FacialVerificationScreenRoute());
                        });
                      }
                          : null,
  ...
  void _validate11Digits() {
    ...
    if (value.isEmpty) {
      ...
      final allDigits = value.replaceAll(RegExp(' '), '');
      if (allDigits.length < 11) {
        setState(() => _errorText = "BVN Verification Unsuccessful");
      } else {

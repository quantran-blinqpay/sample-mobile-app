...
@RoutePage(name: takeProofOfAddressPictureRoute)
class TakeProofOfAddressPictureScreen extends StatefulWidget {
  const TakeProofOfAddressPictureScreen({super.key});

  @override
  State<TakeProofOfAddressPictureScreen> createState() =>
      _TakeProofOfAddressPictureScreenState();
}

class _TakeProofOfAddressPictureScreenState
    extends State<TakeProofOfAddressPictureScreen> {
  ...
  void _usePhoto(BuildContext context) async {
    ...
    if (selected != null) {
      ...
      context.router.popUntilRouteWithName(tier3VerificationRoute);
      // Get.until((route) => Get.currentRoute == AppRoutes.tier3Verification);
    }
  }

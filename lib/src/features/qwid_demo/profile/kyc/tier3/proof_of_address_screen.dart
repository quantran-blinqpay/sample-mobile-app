...
@RoutePage(name: proofOfAddressRoute)
class ProofOfAddressScreen extends StatefulWidget {
  const ProofOfAddressScreen({super.key});

  @override
  State<ProofOfAddressScreen> createState() => _ProofOfAddressScreenState();
}
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                const Text(
                  "Upload a clear image or PDF of your proof of address to verify your identity",
                  style: TextStyle(
                    fontFamily: 'Creato Display',
                    fontSize: 14,
                    fontWeight: FontWeight.w400,

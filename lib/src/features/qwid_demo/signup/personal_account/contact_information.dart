...
import 'package:qwid/src/features/qwid_demo/signup/personal_account/select_city_bottom_sheet.dart';
import 'package:qwid/src/features/qwid_demo/signup/personal_account/select_state_bottom_sheet.dart';
...
class _ContactInformationScreenState extends State<ContactInformationScreen> {
  ...
  void _openStateSelector(BuildContext context) async {
    final selected = await showModalBottomSheet<String>(
      ...
      builder: (_) => SelectStateBottomSheet(title: _stateController.text),
    );
  ...
  void _openCitySelector(BuildContext context) async {
    final selected = await showModalBottomSheet<String>(
      ...
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => SelectCityBottomSheet(title: _cityController.text),
    );

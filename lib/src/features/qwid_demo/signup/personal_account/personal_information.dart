...
import 'package:qwid/src/features/qwid_demo/signup/personal_account/select_country_code_bottom_sheet.dart';
...
class _PersonalInformationScreenState extends State<PersonalInformationScreen> {
              ...
              children: [
                Expanded(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      _openCountryCodeSelector(context);
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                child: ElevatedButton(
                  onPressed: isFormValid
                    ...
                    context.router.push(AccountVerificationScreenRoute()).then((value) {
                      if (value != null) {
                        context.router.push(const ContactInformationScreenRoute());
                      }
                    });
                    } : null,
  ...
  void _openCountryCodeSelector(BuildContext context) async {

      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(icQwidWarning, width: 91, height: 64),
            const SizedBox(height: 8),
            Text(
              "Important Update On Your Bank Account Details.",
              style: TextStyle(
            ...
            const SizedBox(height: 8),
            Text(
              "We're introducing account details, now you can receive funds directly into your account in any currency.",
              style: TextStyle(
                fontFamily: "Creato Display",
                fontSize: 14,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed:  () {
                  _openVirtualAccountSelector(context);
                },

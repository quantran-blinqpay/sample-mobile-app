...
@RoutePage(name: selectSecondSubCategoryScreenName)
class SelectSecondSubCategory extends StatefulWidget {
  const SelectSecondSubCategory({
    super.key,
    required this.data,
  });
  ...
  @override
  State<SelectSecondSubCategory> createState() =>
      _SelectSecondSubCategoryState();
}

class _SelectSecondSubCategoryState extends State<SelectSecondSubCategory> {
            ...
            children: [
              Padding(
                ...
                child: CustomTextFormField(
                  ...
                  hintText: 'Search second sub categories...',
                    ...
                    return ElevatedAppButton(
                      onPressed: () async {
                        context.read<CreateListingCubit>()
                          ..updateSecondSubCategory(item)
                          ..getConditions(item?.id)
                          ..getDwpostFreight(item?.id);
                            ...
                            child: Row(
                              children: [
                                ...
                                SvgPicture.asset(
                                  ...
                                  height: 24,
                                  colorFilter: ColorFilter.mode(
                                    state.secondsubCategory?.id == item?.id
                                        ? appColors!.black
                                        : appColors!.white,
                                    BlendMode.srcIn,
                                  ),

...
part 'recommended_brand_au_setting.g.dart';

@JsonSerializable()
class RecommendedBrandAUSetting {
  ...
  factory RecommendedBrandAUSetting.fromJson(Map<String, dynamic> json) => _$RecommendedBrandAUSettingFromJson(json);

  Map<String, dynamic> toJson() => _$RecommendedBrandAUSettingToJson(this);

  const RecommendedBrandAUSetting({
    this.item1,
    this.item2,
    this.item3,
    this.item4,

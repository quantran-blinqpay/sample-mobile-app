...
AskQuestionResponse askQuestionResponseFromJson(String str) =>
    AskQuestionResponse.fromJson(json.decode(str));

String askQuestionResponseToJson(AskQuestionResponse data) =>
    json.encode(data.toJson());

@JsonSerializable()
class AskQuestionResponse {
  @JsonKey(name: "data")
  AskQuestionResponseData? data;
  ...
  factory AskQuestionResponse.fromJson(Map<String, dynamic> json) =>
      _$AskQuestionResponseFromJson(json);

  Map<String, dynamic> toJson() => _$AskQuestionResponseToJson(this);
}

@JsonSerializable()
class AskQuestionResponseData {
  @JsonKey(name: "id")
  int? id;
  ...
  factory AskQuestionResponseData.fromJson(Map<String, dynamic> json) =>
      _$AskQuestionResponseDataFromJson(json);

  Map<String, dynamic> toJson() => _$AskQuestionResponseDataToJson(this);
}

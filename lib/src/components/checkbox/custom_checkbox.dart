...
class CheckboxSize {
  ...
  static const size20 = CheckboxSize(
    size: 20,
    radius: Radius.circular(2.22),
    strokeWidth: 1.11,
  );

  CheckboxSize copyWith({
    double? size,
    Radius? radius,
    double? strokeWidth,
  }) {
    ...
    switch (effectiveMaterialTapTargetSize) {
      ...
      case MaterialTapTargetSize.shrinkWrap:
        size = Size(
          ...
          // kMinInteractiveDimension - 8.0,
          kMinInteractiveDimension - widget.size!.size! / 2,
          kMinInteractiveDimension - widget.size!.size! / 2,
        );
        break;
    }
      ...
      child: Padding(
        ...
        child: buildToggleable(
          ...
          painter: _painter
            ...
            ..activeSide = BorderSide(
              width: widget.size!.strokeWidth!,
              color: widget.borderColor ?? Color(0xFFC6C6C6),
            )
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    final start = Offset(sizeValue!.size! * 0.3, sizeValue!.size! * 0.55);
    final mid = Offset(sizeValue!.size! * 0.45, sizeValue!.size! * 0.68);
    final end = Offset(sizeValue!.size! * 0.8, sizeValue!.size! * 0.3);
    if (t < 0.5) {
